...
//   toggleTask: boolean,
// }
// const Alltask:React.FC<AlltaskProps> = (tasks,edited,setedited,toggleDone,toggleEdit,deleteHandler,toggleTask) => {
              ...
              {task.editable ? (
                <View>
                  <TextInput
                    ...
                    onChangeText={setedited}
                  />
                  <View style={{ flexDirection: 'row', gap: 6, marginLeft: 210 }}>
                    <Pressable onPress={() => toggleDone(task.id)} style={styles.doneBtn}>
                      <Text style={{ color: 'white' }}>Done</Text>
                    </Pressable>
                    <Pressable
                      onPress={() => toggleEdit(task.id)}
                      style={[styles.doneBtn, { backgroundColor: '#3d3d3d' }]}
                    >
